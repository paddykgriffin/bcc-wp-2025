...
<article id="post-<?php the_ID(); ?>" <?php post_class('pb-12'); ?>>
	...
	<header class="entry-header py-12 text-center text-primary">
		<?php
		the_title( '<h1 class="pb-0 text-5xl font-bold">', '</h1>' );
		?>
	</header><!-- .entry-header -->



	<div <?php bcc_content_class( 'grid grid-cols-12 items-center gap-8' ); ?>>
